...
| 现场分组 | 5–6 个岛式小组，每组 4–6 人，每组固定 1 名技术助教 |
...
| 级别 | 必须达成 | 处理原则 |
| --- | --- | --- |
| P0 交付底线 | 收费名单准确、通知送达、账号可用、场地安全、课程可讲、标准案例可运行、签到与现场支持可用 | 任一项未通过即升级总负责人，不得带病开课 |
| P1 核心体验 | 学员课前有准备、现场不掉队、问题及时响应、个人成果可验收、反馈可实时纠偏 | 资源优先保障，非必要展示为其让路 |
| P2 AI 原生示范 | 主数据中心、自动任务流、实时看板、问题智能分派、自动复盘 | 必须有稳定版和人工兜底 |
| P3 增强体验 | 摄影、精美物料、更多案例、复杂集成、传播素材 | 只在 P0–P2 全部稳定后执行 |
...
- 现场问题先进入飞书问题表，再按“技术助教 → 技术负责人/主讲 → 总负责人”升级。
...
| 工作 | 总负责人 | 课程负责人/主讲 | 技术/数据 | 学员运营 | 会务/安全 | 技术助教 | 企业对接 |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 课程范围与成功标准 | A | R | C | C | I | I | C |
| 课程材料与标准案例 | I | A/R | C | I | I | C | I |
| 飞书完整数据模型 | I | C | A/R | C | I | I | C |
| 支付数据导入与核对 | I | I | R | A/R | I | I | C |
| 学员名单与入班 | I | I | C | A/R | I | I | C |
| 教学账号与沙箱 | I | C | A/R | R | I | C | I |
| 课前任务与催办 | I | C | C | A/R | I | I | C |
| 场地、餐饮与物料 | I | I | C | C | A/R | I | I |
| 技术联调与应急 | I | C | A/R | I | C | R | I |
| 现场授课与节奏 | I | A/R | C | C | C | R | I |
| 课堂问题 SLA | I | C | A | C | I | R | I |
| 学员体验预警 | I | C | C | A/R | C | R | I |
| 成果逐人验收 | I | A | C | I | I | R | I |
| 摄影与授权 | I | I | I | C | A/R | I | I |
| 安全事件处置 | A | I | C | C | R | I | I |
| 课后辅导与回访 | I | C | C | A/R | I | R | C |
| 企业汇总报告 | I | C | R | C | I | I | A/R |
| 课程复盘与模板化 | A | R | R | R | C | C | C |
...
5. 按业务环节建议分组，并支持人工确认。
6. 参课确认、交通、课前任务、开课和异常提醒。
7. 现场签到、迟到缺席标记和实时运营看板。
...
- 会务负责人确认场地书面信息、进场时间、桌椅、电源、网络、投屏、音响、餐饮和供应商联系人。
...
- 全体技术助教参加培训：跑通模板、处理高频错误、理解 SLA、掌握验收标准和数据安全边界。
- 会务负责人确认餐饮预估、物料数量、座位图、桌牌、插排和备用设备。
...
- 向全体学员发送最终提醒：时间、地点、交通、电脑、电源、账号、数据安全和联系人。
...
| 时间 | 环节 | 举办方关键动作 | 学员产出 |
| --- | --- | --- | --- |
| 08:00–08:25 | 团队站会与复检 | 检查 P0、岗位、签到、环境、应急和当日指标 | 无 |
| 08:30–09:00 | 签到与设备就绪 | 自动签到；未验证账号进入补救台；按组引导入座 | 完成登录和模板打开 |
...
| 时间 | 环节 | 举办方关键动作 | 学员产出 |
| --- | --- | --- | --- |
| 08:00–08:25 | 团队站会与复检 | 根据第 1 天数据调整助教资源、内容和重点学员 | 无 |
| 08:30–09:00 | 签到与个别补救 | 处理第 1 天未完成模板和账号异常 | 恢复到共同起点 |
...
flowchart TD
    ...
    B --> C{"问题等级"}
    C -->|技术阻塞| D["固定技术助教 5 分钟响应"]
    C -->|普通问题| E["负责人 30 分钟响应"]
    C -->|共性问题| F["进入集中答疑队列"]
    C -->|复杂或敏感| G["升级技术负责人或主讲"]
    D --> H["记录处理结果"]
    E --> H
    F --> H
    G --> I{"当日可闭环"}
...
- 学员核对姓名后完成签到，不在公开名单上展示手机号或企业敏感信息。
